...
func TestLogEventMessageInfo(t *testing.T) {
	...
	bufWriter.Flush()
	assert.Equal(t, "{\"time\":\"NODATE\",\"level\":\"INFO\",\"msg\":\"Some message\",\"EventInfoMessage\":{\"Topic\":\"platform.todos.todo-created\",\"Key\":\"\",\"Headers\":\"{}\"}}\n", buf.String())
}
...
func TestLogEventMessageError(t *testing.T) {
	...
	bufWriter.Flush()
	assert.Equal(t, "{\"time\":\"NODATE\",\"level\":\"ERROR\",\"msg\":\"Error processing event message\",\"EventErrorMessage\":{\"Headers\":[{\"Key\":\"Topic\",\"Value\":\"cGxhdGZvcm0udG9kb3MudG9kby1jcmVhdGVk\"}],\"Payload\":\"{\\\"uuid\\\":\\\"28304ad2-512c-11ed-bd7e-482ae3863d30\\\",\\\"url\\\":\\\"https://example.test\\\"}\",\"Error\":\"Any error message\"}}\n", buf.String())
}
